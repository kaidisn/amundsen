...
if __name__ == "__main__":
    ...
    # run_csv_job('example/acorns_data/redshift_table_owners.csv', 'redshift_table_owner_metadata',
    #             'databuilder.models.table_owner.TableOwner')
    ...
    run_csv_job('example/sample_data/acorns_employee.csv', 'test_user_metadata',
